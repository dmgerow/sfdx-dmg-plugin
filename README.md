...
_See code: [src/commands/dmg/attachments/uploadasfiles.ts](https://github.com/dmgerow/sfdx-dmg-plugin/blob/v0.1.1/src/commands/dmg/attachments/uploadasfiles.ts)_
