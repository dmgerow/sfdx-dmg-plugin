...
* [`sfdx dmg:source:cleanup [-p <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-dmgsourcecleanup--p-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
_See code: [lib/commands/dmg/connectedapp/create.js](https://github.com/dmgerow/sfdx-dmg-plugin/blob/v0.0.6/lib/commands/dmg/connectedapp/create.js)_
...
_See code: [lib/commands/dmg/files/base64decode.js](https://github.com/dmgerow/sfdx-dmg-plugin/blob/v0.0.6/lib/commands/dmg/files/base64decode.js)_
...
_See code: [lib/commands/dmg/knowledge/convert.js](https://github.com/dmgerow/sfdx-dmg-plugin/blob/v0.0.6/lib/commands/dmg/knowledge/convert.js)_
...
_See code: [lib/commands/dmg/knowledge/convertosc.js](https://github.com/dmgerow/sfdx-dmg-plugin/blob/v0.0.6/lib/commands/dmg/knowledge/convertosc.js)_

## `sfdx dmg:source:cleanup [-p <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

clear directories

```
USAGE
  $ sfdx dmg:source:cleanup [-p <string>] [--json] [--loglevel 
  trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]

OPTIONS
  -p, --path=path                                                                   path to sfdx source
  --json                                                                            format output as json
...
_See code: [lib/commands/dmg/source/cleanup.js](https://github.com/dmgerow/sfdx-dmg-plugin/blob/v0.0.6/lib/commands/dmg/source/cleanup.js)_
...
_See code: [lib/commands/dmg/workbench/open.js](https://github.com/dmgerow/sfdx-dmg-plugin/blob/v0.0.6/lib/commands/dmg/workbench/open.js)_
<!-- commandsstop -->
